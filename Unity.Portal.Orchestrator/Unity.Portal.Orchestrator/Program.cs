...
builder.Services.AddElsa(elsa =>
{
    ...
    var connectionString =  builder.Configuration.GetConnectionString("DefaultConnection") ?? throw new Exception("Error with db connection");
    Console.WriteLine("!!!!!!!!!!!!!!!!!");
    elsa.UseWorkflowManagement(options => options.UseEntityFrameworkCore(ef => ef.UsePostgreSql(connectionString)));
